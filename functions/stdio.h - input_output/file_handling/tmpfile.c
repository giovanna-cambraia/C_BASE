...
// ? OBS - Security note historical, mostly relevant to tmpnam, but worth knowing since they're related): tmpfile itself is reasonably safe on POSIX systems because 
